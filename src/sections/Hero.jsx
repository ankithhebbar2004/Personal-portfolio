          ...
          <div className="space-y-8">
            <div className="animate-fade-in">
              <span className="inline-flex items-center gap-2 px-4 py-2 rounded-full glass text-sm text-primary">
                ...
                Software Engineer - Data Analyst / AI
              </span>
            </div>
            ...
            <div className="space-y-4">
              ...
              <p className="text-lg text-muted-foreground max-w-lg animate-fade-in animation-delay-200">
                Hi, I'm Ankith Hebbar — a software engineer specializing in
                Machine Learning, Data Science, and Software Testing. I build
                scalable, performant applications that are tailored towards
                users.
              </p>
            </div>
            ...
            <div className="flex items-center gap-4 animate-fade-in animation-delay-400">
              ...
              {[
                {
                  icon: FaGithub,
                  href: "https://github.com/ankithhebbar2004",
                },
                {
                  icon: FaLinkedin,
